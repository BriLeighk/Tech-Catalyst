...
export default function Home() {
  ...
  return (
    <div className="bg-white"> {/*TODO: Change background color*/}
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between"> {/*TODO: Change panel background color*/}
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">The Tech Catalyst</span>
                <img
                  alt=""
                  src="" /*TODO: Add logo to navigation menu*/
                  className="h-8 w-auto"
                />
              </a>
              <button
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  ...
                  >
                    Log in
                  </a> {/*TODO: Make actionable --> should navitate to a login page*/}
                </div>
              </div>
            </div>
          </DialogPanel>
